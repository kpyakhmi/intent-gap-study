...
3. Upload `code/colab_pilot.ipynb` from your local clone of this repo.
...
8. Open this repo in the browser. Go into the `data/` folder. Click **Add file → Upload files**. Drag in both downloaded files. Commit.
...
- **Out of memory**: drop `SAMPLE_SIZE` to 5,000 in the streaming cell.
- **Streaming is slow**: Colab's free tier sometimes throttles. Try again at a different time.
